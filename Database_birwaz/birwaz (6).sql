...
--
-- Host: localhost:8889
-- Generation Time: Dec 01, 2025 at 01:37 AM
...
(50, 397, 'white', '0', 'yellow', '15', '45', '{\"background\":\"white\",\"lighting\":\"yellow\",\"decorations\":[{\"id\":\"decor-1764552674114\",\"name\":\"Chair\",\"price\":15,\"src\":\"images/img3.png\",\"x\":365.25,\"y\":269,\"scale\":0.3875,\"angle\":0},{\"id\":\"decor-1764552636810\",\"name\":\"Curtain\",\"price\":30,\"src\":\"images/img5.png\",\"x\":169.25,\"y\":-75,\"scale\":1.1892500000000001,\"angle\":0}]}', 'design_1764552703.png');
...
(397, 'Custom Design - 12/1/2025', 'Custom Design with White Background and Yellow Lighting and Chair, Curtain', 'design_1764552703.png', 'customized');
...
(49, 59, 'Your studio reservation #59 is confirmed for 2025-12-08 at 5:00 PM - 6:00 PM', '2025-12-01'),
(50, 60, 'Your studio reservation #60 is confirmed for 2025-12-20 at 12:00 PM - 1:00 PM', '2025-12-01'),
(51, 61, 'Your studio reservation #61 is confirmed for 2025-12-09 at 3:00 PM - 4:00 PM', '2025-12-01');
...
(59, 4, 336, '2025-12-08', '5:00 PM - 6:00 PM', '50', '2025-12-01 01:29:57', 'confirmed'),
(60, 4, 340, '2025-12-20', '12:00 PM - 1:00 PM', '50', '2025-12-01 01:30:16', 'confirmed'),
(61, 4, 397, '2025-12-09', '3:00 PM - 4:00 PM', '110', '2025-12-01 01:31:54', 'confirmed');
...
--
ALTER TABLE `customizedesign`
  MODIFY `CustomizeID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `design`
  MODIFY `DesignID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=398;

--
-- AUTO_INCREMENT for table `notification`
--
ALTER TABLE `notification`
  MODIFY `NotificationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `reservation`
--
ALTER TABLE `reservation`
  MODIFY `ReservationID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
