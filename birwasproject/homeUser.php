    ...
    <body>
       <header>
            <div class="container nav">
                ...
                <nav class="links">
                    <a href="homeUser.php" aria-current="page">Home</a>
        ...
        <main class="container">
            ...
            <section id="results" class="grid">
                ...
                <a href="Customize.php" class="col-4 card">
                   <figure class="thumb">
                     <img src="images/addicon.png" alt="Customize preview">
                   </figure>
                   <div class="body">
                      <h3>Customize</h3>
                   </div>
                ...
                <div class="col-4 card" data-name="Graduation Theme" data-tags="graduation navy gold balloons class capceremony formal celebration backdrop"><a href="Booking.php?design_id=336">

                    <figure class="thumb">
                        <img src="images/stu16.png" alt="Graduation studio preview">
                    </figure>
                    <div class="body">
                        <h3>Graduation Theme</h3>
                ...
                <div class="col-4 card" data-name="White Theme" data-tags="white minimal modern chair sheer curtain fabric clean simple timeless studio"><a href="Booking.php?design_id=338">
                    <figure class="thumb">
                        <img src="images/stu5.jpg" alt="White studio preview">
                    </figure>
                    <div class="body">
                        <h3>White Theme</h3>
                ...
                <div class="col-4 card" data-name="Boho Theme" data-tags="boho bohemian daylight white curtains linen neutral textures organic shapes relaxed natural earthy"><a href="Booking.php?design_id=340">
                    <figure class="thumb">
                        <img src="images/stu8.JPG" alt="Boho  studio preview">
                    </figure>
                    <div class="body">
                        <h3>Boho Theme</h3>
				...
				<div class="col-4 card" ><a href="Booking.php?design_id=334">

                    <figure class="thumb">
                        <img src="images/stu2.JPG" alt="Boho  studio preview">
                    </figure>
                    <div class="body">
                        <h3>Pink Theme</h3>
				...
				<div class="col-4 card" ><a href="Booking.php?design_id=339">

                    <figure class="thumb">
                        <img src="images/stu6.JPG" alt="Boho  studio preview">
                    </figure>
                    <div class="body">
                        <h3>Dark Theme</h3>
