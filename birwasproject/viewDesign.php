...
$sql = "
    SELECT 
        ...
        d.Image_URL
    FROM reservation r
    LEFT JOIN design d ON d.DesignID = r.DesignID
...
$imgSrc = 'images/stu2.jpg'; 

if (!empty($data['Image_URL'])) {

    $file = htmlspecialchars($data['Image_URL']);
...
$designName = !empty($data['design_name']) ? $data['design_name'] : "Customized Design";
$date       = $data['Date'];
$time       = $data['time_slot'];
...
<head>
<meta charset="utf-8" />
<meta name="ViewDesign" content="width=device-width, initial-scale=1" />
...
<main class="containerView">
    <div class="design-box">
        <h2 class="design-title"><?php echo htmlspecialchars($designName); ?></h2>
...
<img src="<?php echo $imgSrc; ?>" alt="<?php echo htmlspecialchars($designName); ?>">
        ...
        <div class="info">
            ...
            <p><strong>Total Price:</strong> <?php echo htmlspecialchars($total); ?> SAR</p>
            <p><strong>Location:</strong> Birwaz studio,Roshn Front,Riyadh</p>
<a href="BookingEdit.php?reservation_id=<?php echo $reservationID; ?>">
