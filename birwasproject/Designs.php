...
$designs = [];
$sql = "SELECT DesignID, Name, Description, Image_URL 
        FROM design 
        WHERE Type = 'Ready'"; 
...
.modal-box {
    background: #fff6bf; /* أصفر نفس الخلفية */
    border: 1px solid #f1e9b6;
    border-radius: 16px;
    padding: 20px 24px;
    max-width: 360px;
...
.modal-btn.confirm:hover{
                        ...
                        <div class="col-4 card" data-name="<?php echo htmlspecialchars($design['Name']); ?>">
                            ...
                            <div class="body">
                                ...
                                <a class="btn primary full"
                                   href="booking.php?design_id=<?php echo urlencode($design['DesignID']); ?>">
                                    Select Design
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal-box">
        ...
        <div class="modal-actions">
            <button type="button" class="modal-btn" id="cancelLogout">Cancel</button>
